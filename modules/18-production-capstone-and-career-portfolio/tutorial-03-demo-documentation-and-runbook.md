# Tutorial 3: Demo, documentation and runbook

## Goal

Learn **demo, documentation and runbook** and apply it to a small part of a enterprise operations agent.

## Why this matters for agents

AI agents combine probabilistic model behavior with deterministic software. The deterministic layer must validate data, control side effects, persist state, enforce permissions and recover from failure. This tutorial treats **demo, documentation and runbook** as an engineering building block rather than an isolated Python topic.
...
```bash
mkdir -p work/module-18/tutorial-3
cd work/module-18/tutorial-3
```
...
Refactor the example so the program explicitly demonstrates **demo, documentation and runbook**. Keep each function small. Give every function a clear input and output. Avoid hidden global state.
