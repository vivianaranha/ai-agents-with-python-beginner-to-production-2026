# Tutorial 3: Clients, tools, resources and prompts

## Goal

Learn **clients, tools, resources and prompts** and apply it to a small part of a enterprise operations agent.

## Why this matters for agents

AI agents combine probabilistic model behavior with deterministic software. The deterministic layer must validate data, control side effects, persist state, enforce permissions and recover from failure. This tutorial treats **clients, tools, resources and prompts** as an engineering building block rather than an isolated Python topic.
...
```bash
mkdir -p work/module-11/tutorial-3
cd work/module-11/tutorial-3
```
...
Refactor the example so the program explicitly demonstrates **clients, tools, resources and prompts**. Keep each function small. Give every function a clear input and output. Avoid hidden global state.
